          ...
          <div class="col s3">
            <div class="card">
              <div class="card-content">
                <div class="row">
                  <div class="col s12">
                    <form action="{{ route('languageList.store') }}" method="POST" enctype="multipart/form-data">
                      @csrf
                      <div class="col s12 input-field">
                        <input id="language" name="language" type="text" class="validate @error('language') is-invalid @enderror" value="{{ old('language') }}" autocomplete="language" required 
                      ...
                      <div class="col s12 input-field">
                        <input id="language_iso_code_2" name="language_iso_code_2" type="text" class="validate @error('language_iso_code_2') is-invalid @enderror" value="{{ old('language_iso_code_2') }}" autocomplete="language_iso_code_2" required 
                          data-error=".errorTxt1">
                      ...
                      <div class="col s12 input-field">
                        <input id="language_iso_code_3" name="language_iso_code_3" type="text" class="validate @error('language_iso_code_3') is-invalid @enderror" value="{{ old('language_iso_code_3') }}" autocomplete="language_iso_code_3" required 
                          data-error=".errorTxt1">
