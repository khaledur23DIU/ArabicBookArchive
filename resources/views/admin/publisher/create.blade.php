...
@section('title', __('Create New Publisher'))
...
<div class="card">
    <div class="card-content s8">
  	<form action="{{ route('publicationInfo.store') }}" method="POST" enctype="multipart/form-data">
  		@csrf
          <div class="card-content">
          	<div class="row">
              <div class="input-field col m6 s10">
                <label for="publicationName">{{__('Name of the Publication')}}: <span class="red-text">*</span> </label>
                <input type="text" id="publicationName" value="{{old('publicationName')}}" name="publicationName" class="validate @error('publicationName') is-invalid @enderror" data-error=".errorTxt1" required>
