...
<div class="card">
    <div class="card-content">
  	<form action="{{ route('libraryList.update',$library->id) }}" method="POST" enctype="multipart/form-data">
  		@csrf 
  		@method('PUT') 		
          <div class="card-content">
          	<div class="row">
              <div class="input-field col m4 s10">
                ...
                <input type="text" id="libraryName" value="{{$library->libraryName}}" name="libraryName" class="validate @error('libraryName') is-invalid @enderror" data-error=".errorTxt1" required autofocus="libraryName">
                @error('libraryName')
              ...
              <div class="input-field col m4 s10">
                <select class="select2 browser-default @error('country') is-invalid @enderror" id="country" name="country">
                  ...
                  <option 
                    @if (!empty($library->place))
                       {{$library->place->country->id == $country->id ? 'selected':''}}
              ...
              <div class="input-field col m4 s10">
                <select class="select2 browser-default @error('city') is-invalid @enderror" id="city" name="city">
                  ...
                  @foreach ($library->place->country->cities as $city)
                    <option {{$city->id == $library->placeID ? 'selected':'' }} value="{{$city->id}}">{{$city->city}}</option>
                  @endforeach
                </select>
                @error('city')
                <small class="red-text errorTxt1">{{ __($message) }}</small>
            ...
            <div class="row">
            	<div class="input-field col m6 s10">
	                ...
	                <input id="stablishedYearHijri" value="{{$library->stablishedYearHijri}}" name="stablishedYearHijri" type="number" min="1" class="validate @error('stablishedYearHijri') is-invalid @enderror" data-error=".errorTxt1">
	            ...
	            <div class="input-field col m6 s10">
	                ...
	                <input id="stablishedYearIsae" name="stablishedYearIsae" value="{{$library->stablishedYearIsae}}" type="number" min="1" class="validate @error('stablishedYearIsae') is-invalid @enderror" data-error=".errorTxt1">
            	...
            	<div class="input-field col m6 s10">
	                ...
	                <input type="url" id="website" name="website" value="{{$library->web}}" class="validate @error('website') is-invalid @enderror" data-error=".errorTxt1">
	                @error('website')
	                <small class="red-text errorTxt1">{{ __($message) }}</small>
	                @enderror
	            </div>
	            <div class="input-field col m6 s10">
	                ...
	                <input type="email" id="email" name="email" value="{{$library->email}}" class="validate @error('email') is-invalid @enderror" data-error=".errorTxt1">
	                @error('email')
	                <small class="red-text errorTxt1">{{ __($message) }}</small>
	                @enderror
	            </div>
            	...
            	<div class="input-field col m6 s10">
	                ...
	                <input type="text" id="phone" name="phone" value="{{$library->phone}}" class="validate @error('phone') is-invalid @enderror" data-error=".errorTxt1">
	                @error('phone')
	                <small class="red-text errorTxt1">{{ __($message) }}</small>
	                @enderror
	            </div>
	            <div class="input-field col m6 s10">
	                ...
	                <input type="text" id="mobile" name="mobile" value="{{$library->mobile}}" class="validate @error('mobile') is-invalid @enderror" data-error=".errorTxt1">
	                @error('mobile')
	                <small class="red-text errorTxt1">{{ __($message) }}</small>
	                @enderror
	            </div>
            	...
            	<div class="input-field col m6 s10">
	                ...
	                <input type="url" id="facebook" name="facebook" value="{{$library->facebook}}" class="validate @error('facebook') is-invalid @enderror" data-error=".errorTxt1">
	                @error('facebook')
	                <small class="red-text errorTxt1">{{ __($message) }}</small>
	                @enderror
	            </div>
	            <div class="input-field col m6 s10">
	                ...
	                <input type="url" id="instagram" name="instagram" value="{{$library->instagram}}" class="validate @error('instagram') is-invalid @enderror" data-error=".errorTxt1">
	                @error('instagram')
	                <small class="red-text errorTxt1">{{ __($message) }}</small>
	                @enderror
	            </div>
            	...
            	<div class="input-field col m6 s10">
	                ...
	                <input type="url" id="twitter" name="twitter" value="{{$library->twitter}}" class="validate @error('twitter') is-invalid @enderror" data-error=".errorTxt1">
	                @error('twitter')
	                <small class="red-text errorTxt1">{{ __($message) }}</small>
	                @enderror
	            </div>
	            <div class="input-field col m6 s10">
	                ...
	                <input type="url" id="linkedIn" name="linkedIn"value="{{$library->linkedIn}}" class="validate @error('linkedIn') is-invalid @enderror" data-error=".errorTxt1">
	                @error('linkedIn')
	                <small class="red-text errorTxt1">{{ __($message) }}</small>
	                @enderror
	            </div>
            	...
            	<div class="input-field col m6 s10">
	                ...
	                <input type="url" id="youtube" name="youtube" value="{{$library->youtube}}" class="validate @error('youtube') is-invalid @enderror" data-error=".errorTxt1">
	                @error('youtube')
	                <small class="red-text errorTxt1">{{ __($message) }}</small>
	                @enderror
	            </div>
	            <div class="input-field col m6 s10">
	                ...
	                <input type="text" id="gMap" name="gMap" value="{{$library->locationMapLink}}" class="validate @error('gMap') is-invalid @enderror" data-error=".errorTxt1">
	                @error('gMap')
	                <small class="red-text errorTxt1">{{ __($message) }}</small>
	                @enderror
	            </div>
            ...
            <div class="step-actions">
              <div class="row">
                ...
                <button type="submit" class="btn indigo">
                  {{ __('Update') }}</button>
                <a href="{{ route('libraryList.index') }}" class="btn btn-light">{{ __('Cancel') }}</a>
              </div>
              </div>
            </div>
          </div>
