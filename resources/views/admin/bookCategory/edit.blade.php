          ...
          <div class="col s3">
            <div class="card">
              <div class="card-content">
                <div class="row">
                  <div class="col s12">
                    <form action="{{ route('bookCategory.update',$bookCategory->id) }}" method="POST" enctype="multipart/form-data">
                      @csrf
                      @method('PUT')
                      <div class="col s12 input-field">
                        <input id="bookCategory" name="bookCategory" type="text" class="validate @error('bookCategory') is-invalid @enderror" value="{{ $bookCategory->bookCategory }}" autocomplete="bookCategory" required 
