...
var MStepper = function() {
    function E(e) {
        ...
        _classCallCheck(this, E), _defineProperty(this, "_init", function() {
            ...
            var t = 1 < arguments.length && void 0 !== arguments[1] && arguments[1],
                ...
                i = function(e) {
                    ...
                    return u(t, "click", l, !1), u(n, "click", c, !1), v.stepTitleNavigation && u(i, "click", p), r.length && u(r[r.length - 1], "keydown", f), s && d && v.validationFunction && u(s, "keydown", a), e
                };
            e instanceof Element ? i(e) : n(e, function(e) {
                return i(e)
            })
            ...
            return e.classList.remove(s.DONESTEP), window.innerWidth < 993 || !l.classList.contains(s.HORIZONTALSTEPPER) ? (r(v, s.ACTIVESTEP, e, t), i || r(v, s.ACTIVESTEP, e, function() {
                var e = v.querySelector("input, select, textarea");
                p.autoFocusInput && e && e.focus(), t && "function" == typeof t && t()
            })) : e.classList.add(s.ACTIVESTEP), d && n && (a(d), l.dispatchEvent(c.STEPCHANGE)), l.dispatchEvent(c.STEPOPEN), e
            ...
            if (window.innerWidth < 993 || !r.classList.contains(i.HORIZONTALSTEPPER)) t(l, i.ACTIVESTEP, e, n);
            else {
                if (n) {
            ...
            return E && !f() ? a() : P && !t ? (u && !h.step.dataset.nopreloader && s(), void window[P](v, o, h.step.querySelector(".".concat(l.STEPCONTENT)))) : (h.step.classList.add(l.DONESTEP), c(y, e), void p.dispatchEvent(d.NEXTSTEP))
            ...
            E.addMultipleEventListeners(r, "input", function e() {
                t().active.step.classList.remove(n.WRONGSTEP), E.removeMultipleEventListeners(r, "input", e)
            ...
            var e = g.getSteps,
                ...
                r = g.events,
                s = e().active.step;
            s.classList.add(t.FEEDBACKINGSTEP), s.getElementsByClassName(t.STEPCONTENT)[0].insertAdjacentHTML("afterBegin", '<div class="'.concat(t.PRELOADERWRAPPER, '">').concat(n.feedbackPreloader, "</div>")), i.dispatchEvent(r.FEEDBACKING)
            ...
            if (o && o.classList.contains(n.FEEDBACKINGSTEP)) {
                ...
                a.parentNode.removeChild(a), e && i(void 0, !0), r.dispatchEvent(s.FEEDBACKDESTROYED)
            }
            ...
            var n = g.getSteps,
                ...
                p = null;
            if ("string" == typeof e) c.insertAdjacentHTML(l ? "beforeBegin" : "afterEnd", e.trim()), p = l ? c.previousSibling : c.nextSibling, i(p);
            else if (Array.isArray(e)) p = [], e.forEach(function(e) {
                ...
                p = d(e, c), e instanceof Element ? i(p) : o(p, function(e) {
                    return i(e)
                })
            }
            return p && s(p), p
            ...
            var n = g._slideUp,
                ...
                e = E.nodesIterator,
                s = function(e) {
                    i.contains(t) && (r(e, !0), n(e, void 0, void 0, function() {
                        return i.removeChild(e)
                    }))
                };
            return t instanceof Element ? s(t) : (t instanceof HTMLCollection || t instanceof NodeList) && e(t, function(e) {
                return s(e)
            }), t
            ...
            var t = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : n,
                ...
                s = function e(t) {
                    "height" === t.propertyName && (g._smartListenerUnbind(n, "transitionend", e), E.removeMultipleProperties(n, "visibility overflow height display"), i && i())
                };
            return requestAnimationFrame(function() {
                n.style.display = "none", requestAnimationFrame(function() {
                    n.style.overflow = "hidden", n.style.height = "0", n.style.paddingBottom = "0", n.style.visibility = "unset", n.style.display = "block", requestAnimationFrame(function() {
                        g._smartListenerBind(n, "transitionend", s), n.style.height = r, n.style.removeProperty("padding-bottom"), e && t.classList.add(e)
                    })
                })
            }), n
            ...
            var t = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : n,
                ...
                s = function e(t) {
                    "height" === t.propertyName && (g._smartListenerUnbind(n, "transitionend", e), n.style.display = "none", E.removeMultipleProperties(n, "visibility overflow height padding-bottom"), i && i())
                };
            return requestAnimationFrame(function() {
                n.style.overflow = "hidden", n.style.visibility = "unset", n.style.display = "block", n.style.height = r, requestAnimationFrame(function() {
                    g._smartListenerBind(n, "transitionend", s), n.style.height = "0", n.style.paddingBottom = "0", e && t.classList.remove(e)
                })
            }), n
            ...
            return o.method = r, o.action = s, e.parentNode.insertBefore(o, e), o.appendChild(e), o
            ...
            if (i)
                for (var a = 0; a < s.length; a++) {
                    var l = s[a];
                    l.event === t && l.el.isSameNode(e) && l.el.removeEventListener(l.event, l.fn), r && l.fn()
                } else {
                    var c = s.indexOf(o);
                    if (-1 !== p) {
                        var p = s[c];
    ...
    return _createClass(E, null, [{
        ...
        value: function(e, t, n) {
            ...
            for (var r = 0, s = e.length; r < s; r++) e[r].addEventListener(t, n, i)
        }
    }, {
        ...
        value: function(e, t, n) {
            ...
            for (var r = 0, s = e.length; r < s; r++) e[r].removeEventListener(t, n, i)
        }
    }, {
        ...
        value: function(e) {
            ...
            return E.removeMultipleProperties(e, "position display top left height opacity z-index pointer-events"), t
        }
    }, {
