          ...
          <div class="col s3">
            <div class="card">
              <div class="card-content">
                <div class="row">
                  <div class="col s12">
                    <form action="{{ route('countryList.store') }}" method="POST" enctype="multipart/form-data">
                      @csrf
                      <div class="col s12 input-field">
                        <input id="country" name="country" type="text" class="validate @error('country') is-invalid @enderror" value="{{ old('country') }}" autocomplete="country" required 
                      ...
                      <div class="col s12 input-field">
                        <input id="country_iso_code_2" name="country_iso_code_2" type="text" class="validate @error('country_iso_code_2') is-invalid @enderror" value="{{ old('country_iso_code_2') }}" autocomplete="country_iso_code_2" required 
                          data-error=".errorTxt1">
                      ...
                      <div class="col s12 input-field">
                        <input id="country_iso_code_3" name="country_iso_code_3" type="text" class="validate @error('country_iso_code_3') is-invalid @enderror" value="{{ old('country_iso_code_3') }}" autocomplete="country_iso_code_3" required 
                          data-error=".errorTxt1">
                      ...
                      <div class="col s12 input-field">
                        <input id="country_un_code" name="country_un_code" type="number" min="0" class="validate @error('country_un_code') is-invalid @enderror" value="{{ old('country_un_code') }}" autocomplete="country_un_code" required 
                          data-error=".errorTxt1">
