          ...
          <div class="col s3">
            <div class="card">
              <div class="card-content">
                <div class="row">
                  <div class="col s12">
                    <form action="{{ route('placeList.update',$place->id) }}" method="POST" enctype="multipart/form-data">
                      @csrf
                      @method('PUT')
                      <div class="col s12 input-field">
                        <select class="select2 browser-default validate" id="country" name="country" required>
                          ...
                          <option {{ $place->countryID == $country->id ? 'selected':''}} value="{{ $country->id }}">{!! $country->country !!}</option>
                          @endforeach
                        </select>
                      ...
                      <div class="col s12 input-field">
                        <input id="city" name="city" type="text" class="validate @error('city') is-invalid @enderror" value="{{ $place->city }}" autocomplete="city" required 
